...
await app.register(swagger, {
  openapi: {
    ...
    info: {
      ...
      description:
        "Servicio central para medicamentos, inventarios, movimientos y auditoria.",
      version: "1.0.0",
      contact: {
        name: "Equipo SCOPH",
      },
    ...
    tags: [
      ...
      {
        name: "Medicamentos",
        description: "Gestion del catalogo de medicamentos",
      },
      {
        name: "Inventario",
        description: "Inventario central e inventario por jornada",
      },
      {
        name: "Movimientos",
        description: "Entradas, salidas, transferencias, consumos y retornos",
      },
