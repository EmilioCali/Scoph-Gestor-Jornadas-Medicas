...
import toast from "react-hot-toast"; // <-- Instalalo con: npm install react-hot-toast
...
// IMPORTANTE: Asegúrate de tener estas funciones en tu authService.js
// Ej: export const updateUser = (id, data) => authAPI.put(`/api/auth/users/${id}`, data);
