...
export const getMedicines = () => coreAPI.get("/api/v1/medicines");

// POST /api/v1/medicines
export const createMedicine = (data) => coreAPI.post("/api/v1/medicines", data);
...
export const getCategories = () => coreAPI.get("/api/v1/categories");

// POST /api/v1/categories
export const createCategory = (data) =>
  coreAPI.post("/api/v1/categories", data);

// PUT /api/v1/categories/:id
export const updateCategory = (id, data) =>
  coreAPI.put(`/api/v1/categories/${id}`, data);
...
export const getAudit = () => coreAPI.get("/api/v1/auditoria");
