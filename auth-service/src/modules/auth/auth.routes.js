  ...
  fastify.get(
    "/users",
    {
      ...
      schema: {
        ...
        description:
          "Retorna la lista completa de usuarios registrados. ADMIN puede ver, SUPER_ADMIN puede gestionar todo.",
        security: [{ bearerAuth: [] }],
        response: {
          200: {
            type: "object",
  ...
  fastify.patch(
    "/users/:id",
    {
      ...
      schema: {
        ...
        description:
          "Actualiza datos generales de un usuario. ADMIN puede actualizar datos básicos, SUPER_ADMIN puede cambiar roles.",
        security: [{ bearerAuth: [] }],
        params: {
          type: "object",
          required: ["id"],
  ...
  fastify.patch(
    "/users/:id/status",
    {
      ...
      schema: {
        ...
        description:
          "Activa o desactiva una cuenta de usuario. ADMIN puede activar/desactivar, SUPER_ADMIN puede eliminar.",
        security: [{ bearerAuth: [] }],
        params: {
          type: "object",
          properties: {
  ...
  fastify.post(
    "/resend-verification",
    {
      schema: {
        ...
        description:
          "Genera y envía un nuevo código de verificación al correo indicado.",
        body: {
          type: "object",
          required: ["correo"],
          properties: {
          ...
          200: {
            ...
            properties: {
              ...
              message: {
                type: "string",
                example:
                  "Si el correo existe y no está verificado, recibirás un nuevo código",
              },
            },
          },
        },
