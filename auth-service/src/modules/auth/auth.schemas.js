...
export const registerSchema = {
  ...
  description: 'Crea un nuevo usuario. Solo ADMIN o SUPER_ADMIN. El sistema genera una contraseña temporal y la envía automáticamente al correo del nuevo usuario.',
  security: [{ bearerAuth: [] }],
  body: {
    type: 'object',
